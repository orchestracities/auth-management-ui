    ...
    docs: {
      page: () => (
        <>
          ...
          <Description>The form used for the service and subservice creation</Description>
          <Subtitle>API Documentation:</Subtitle>
          <Description>The Service form component is inside service/serviceForm.js :</Description>
