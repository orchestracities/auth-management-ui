        ...
        docs: {
            page: () => (
                <>
                    ...
                    <Description>This table will display the data stored inside the configuration api related to the resource types and their endpoints</Description>
...
ResourceDisplay.args = {
    ...
    env:{ANUBIS_API_URL
        ...
        : 
        "http://localhost:4000/configuration",
        DESCRIPTION
        : 
        "A Management UI for Anubis",
        IMAGE_SIZE
        : 
        "20",
        KEYCLOACK_ADMIN
        ...
        OIDC_ISSUER
        : 
        "http://localhost:8080/realms/default",
        OIDC_SCOPE
        : 
