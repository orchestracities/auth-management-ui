    ...
    docs: {
      page: () => (
        <>
          ...
          <Description>The form used for the tenant modification and creation</Description>
          <Subtitle>API Documentation:</Subtitle>
          <Description>The Tenant form component is inside tenant/tenantForm.js :</Description>
          <Description>The element should be rendered inside the modal</Description>
