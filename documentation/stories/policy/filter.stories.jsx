        ...
        docs: {
            page: () => (
                ...
                <>
                    ...
                    <Description >
                       A set of filters to help the user
                    </Description>
                    <Subtitle >API Documentation:</Subtitle>
                    <Description >
                        The policy filters component is inside policy/policyFilters.js :
                    </Description>
                    <Description >
                        The element should be rendered with the policyTable component inside the same page
                    </Description>
                    <Description >
                        To control every filter the component is using an object is composed by a property with the filter ID and two properties value for the hook value and set for the hook function
                    </Description>
                    <Source
                        language="jsx"
                        dark={true}
...
AllFilters.args = {
    data: [{
        ...
        "id"
            :
            "cb077db5-ec93-48df-923d-99f9ad594799",
        "mode"
            :
            ['acl:Control'],
        "resource_type"
