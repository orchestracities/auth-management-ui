    ...
    docs: {
      page: () => (
        <>
          ...
          <Description>The form used for the policies creation</Description>
          <Description>
            Inside the form is possibile to map the users, the groups and classes is the value of the user type is
            specific, if the value is others is possible to select fixed value
          </Description>
          <Subtitle>API Documentation:</Subtitle>
          <Description>The Policy form component is inside policy/policyForm.js :</Description>
