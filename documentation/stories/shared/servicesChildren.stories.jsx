    ...
    docs: {
      page: () => (
        <>
          ...
          <Description>The button component is inside shared/serviceChildren.js :</Description>
          <Description>
            To let know the component if the service is linked to a Tenant or a Path, you should check the type of form
