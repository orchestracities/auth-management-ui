    ...
    docs: {
      page: () => (
        <>
          ...
          <Description>
            A Button avaitable only on the Tenant page, that is going to reiderect the user to the Policies page, the
            tenant will be change depending on the card that the user has clicked
          </Description>
          <Subtitle>API Documentation:</Subtitle>
          <Description>The button component is inside shared/policiesChildren.js :</Description>
