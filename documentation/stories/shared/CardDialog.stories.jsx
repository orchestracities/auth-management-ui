    ...
    docs: {
      page: () => (
        <>
          ...
          <Description>A simple multifunctional button for the card.</Description>
          <Subtitle>API Documentation:</Subtitle>
          <Description>The multifunctional button component is inside shared/speedDial.js :</Description>
          <Description>
