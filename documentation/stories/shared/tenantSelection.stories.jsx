    ...
    docs: {
      page: () => (
        <>
          ...
          <Description>A Select to change the value of the corrent Tenant selected by the user.</Description>
          <Subtitle>API Documentation:</Subtitle>
          <Description>The Tenant selection component is inside shared/tenantSelection.js :</Description>
          <Description>A possible example of a TenantValue:</Description>
          <Source
            code={JSON.stringify([{ id: 'name', props: { icon: 'copy' }, name: 'name' }])}
            language="javascript"
            dark={true}
          />
