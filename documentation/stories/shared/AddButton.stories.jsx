    ...
    docs: {
      page: () => (
        <>
          ...
          <Description>The button will get the secondary color of the theme decided for the Tenant.</Description>
          <Subtitle>API Documentation:</Subtitle>
          <Description>The air quality component is inside shared/addButton.js :</Description>
