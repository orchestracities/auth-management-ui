...
- `REACT_APP_TABLE_PAGINATION_OPTIONS`: The options for the amount of rows inside the table ([10,25,50]) is suggested
- `REACT_APP_TABLE_DEFAULT_DATA_AMOUNT`: The default amount of displayed rows inside a table
